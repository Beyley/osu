...
namespace osu.Game.Rulesets.Osu.Mods
{
    public class OsuModTaiko : Mod, IApplicableToDrawableHitObjects, IApplicableToHitObject
    {
        ...
        public override string Acronym => "TK";
        ...
        public void ApplyToDrawableHitObjects(IEnumerable<DrawableHitObject> drawables)
        {
            ...
            {
                if (d.HitObject.Samples.Any(s => s.Name == HitSampleInfo.HIT_CLAP || s.Name == HitSampleInfo.HIT_WHISTLE))
                {
                    d.AccentColour.Value = colours.BlueDarker;
                }
                else
                {
                    d.AccentColour.Value = colours.PinkDarker;
                }
            }
        }
        public void ApplyToHitObject(HitObject hitObject)
        {
            ...
            {
                if (h.Samples.Any(s => s.Name == HitSampleInfo.HIT_CLAP || s.Name == HitSampleInfo.HIT_WHISTLE))
                {
